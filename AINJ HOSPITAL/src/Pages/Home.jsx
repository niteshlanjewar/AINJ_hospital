  ...
  return (
    <div className="hero min-h-screen bg-base-300" style={{
      ...
      <div className="hero-content flex-col lg:flex-row">
        ...
        />
        <div>
          <h1 className="text-5xl font-bold">AINJ ORTHOPEDIC HOSPITAL</h1>
          <h3 className="text-2xl font-bold">Where Healing Meets Expertise</h3>
          <p className="py-6">
          At our Orthopedic Hospital, we are dedicated to providing exceptional care and comprehensive solutions for all your orthopedic needs. Our specialized team of expert surgeons, physicians, and medical staff is committed to helping you regain your mobility and improve your quality of life.
          </p>
