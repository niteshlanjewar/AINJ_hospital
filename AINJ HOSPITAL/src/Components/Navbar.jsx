      ...
      <div className="navbar border-2 sticky top-0 shadow-lg bg-blue-300 z-10">
        ...
        <div className="navbar-center hidden lg:flex flex-1 ml-60">
          <ul className="flex justify-center space-x-4">
            ...
            <li>
              <Link to="/todo">
                <button className="btn btn-outline btn-ghost w-28 hover:bg-red-500">Take Your Date</button>
              </Link>
            </li>
            {/* <li>
              <Link to="/shopping">
          ...
          <div className="dropdown dropdown-end">
            ...
            >
              <div className="card-body">
                ...
                <span className="text-info">Subtotal: $1621</span>
